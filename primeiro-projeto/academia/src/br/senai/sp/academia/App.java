...
import br.senai.sp.academia.gui.FrameAcademia;
...
//		clienteEduardo.setSexo('M');
// 		clienteEduardo.setAltura(1.67);
// 		clienteEduardo.setPeso(68.0);
//		clienteEduardo.setNivelDeAtividade(Cliente.MODERADOMASC);

//		System.out.println("Nome: " + clienteEduardo.getNome());
//		System.out.println("Idade: " + clienteEduardo.getIdade());
...
// 		System.out.println("NDC: " + clienteEduardo.getNcdM());
